...
AWS_BUCKET_NAME=YOUR_ACCESS_KEY_HERE

# Or use Cloudinary
FILE_UPLOAD_STRATEGY=cloudinary
CLOUDINARY_CLOUD_NAME=YOUR_ACCESS_KEY_HERE
CLOUDINARY_API_KEY=YOUR_ACCESS_KEY_HERE
CLOUDINARY_API_SECRET=YOUR_ACCESS_KEY_HERE
```
